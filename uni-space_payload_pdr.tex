...
filecolor=black,
urlcolor=black,
pdftitle={UniSpace -- Imaging and Tracking Payload Unit PDR}}
...
\pagestyle{fancy}
\fancyhead[RH]{UniSpace Imaging and Tracking Payload Unit PDR}
...
\def\docversion{A1}					% Possible versions are: DRAFT, REVIEW or RELEASED
